...
class Bookmark {
    ...
    factory Bookmark.fromJson(Map<String, dynamic> json) => Bookmark(
        ...
        bookmarkedProducts: List<BookmarkedProduct>.from(json["bookmarked_products"].map((x) => BookmarkedProduct.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "success": success,
        "bookmarked_products": List<dynamic>.from(bookmarkedProducts.map((x) => x.toJson())),
    };
}
