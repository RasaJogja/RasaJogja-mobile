...
class _BookmarkPageState extends State<BookmarkPage> {
  Future<List<BookmarkedProduct>> fetchBookmarks() async {
    final url = Uri.parse(
        'https://rasajogja-production.up.railway.app/bookmark/bookmarked-products_flutter/');
    try {
  ...
  Future<void> deleteBookmark(int productId) async {
    final url =
        Uri.parse('https://rasajogja-production.up.railway.app/bookmark/remove_flutter/$productId/');
    try {
